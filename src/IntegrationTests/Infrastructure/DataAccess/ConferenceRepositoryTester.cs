...
namespace CodeCampServer.IntegrationTests.Infrastructure.DataAccess
{
	...
	public class ConferenceRepositoryTester : DataTestBase
	{
		...
		public void Should_get_by_key()
		{
			...
			conference.Key = "key";
			conference2.Key = "key2";
			PersistEntities(conference, conference2);
			IConferenceRepository repository = ObjectFactory.GetInstance<ConferenceRepository>();

			Conference byKey = repository.GetByKey("key");

			byKey.ShouldEqual(conference);
		}
	}
}