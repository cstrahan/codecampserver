...
namespace CodeCampServer.Website
{
	public class Global : HttpApplication
	{
		...
		private void initializeControllerFactory()
		{
            ...
            StructureMapConfiguration.BuildInstancesOf<AdminController>().TheDefaultIsConcreteType<AdminController>();
            
		}

		private void setupRoutes()
		{
			var configurator = ObjectFactory.GetInstance<IRouteConfigurator>();
