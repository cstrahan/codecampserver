...
<asp:Content ContentPlaceHolderID="Main" runat="server">
  ...
  <% var form = (UserForm)  ViewData.Model; %>
...
<div class="modal jqmWindow">
	    ...
	    <table class="dataEntry">
		    <tr>
			    <th class="w50p">
                	<%=InputFor<UserForm>(a => a.Id)%>            	
					<div><%=InputFor<UserForm>(a => a.Name)%></div>
					<div><%=InputFor<UserForm>(a => a.EmailAddress)%></div>
					<div><%=InputFor<UserForm>(a => a.Password)%></div>
			    </th>
			    <th class="w50p">
				    <div></div>
			    </th>
