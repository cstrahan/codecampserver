...
{
	[TestFixture]
	public class SubmittedToDraftCommandTester : TestBase
	{
		[Test]
		...
		{
			new SubmittedToDraftCommand().Matches("Reject").ShouldBeTrue();
			new SubmittedToDraftCommand().Matches("foobar").ShouldBeFalse();
		}
