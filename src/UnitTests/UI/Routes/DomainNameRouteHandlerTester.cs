...
namespace CodeCampServer.UnitTests.UI.Routes
{
   ...
   { 
        ...
        public void The_handler_should_pass_the_domain_name_as_route_data()
        {
            ...
            IHttpHandler handler = CreateHandler(routeData, "codecampserver.org:443");
        ...
        {
            var routeData = new RouteData();
            IHttpHandler handler = CreateHandler(routeData, "www.1codecampserver.org");
        ...
        {
            var routeData = new RouteData();
            IHttpHandler handler = CreateHandler(routeData, "localhost:8080");
