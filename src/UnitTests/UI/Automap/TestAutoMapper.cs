...
namespace CodeCampServer.UnitTests.UI.Automap
{
    ...
    public class TestAutoMapper
    {
        ...
        public void can_map_between_userForm_and_user()
        {
            ...
            User user = new User(){Username = "2asdfsad",HashedPassword = "pasdfsa",Id = Guid.NewGuid(),EmailAddress = "",Name = ""};
            UserForm form = (UserForm) AutoMapper.Map(user, typeof(User), typeof(UserForm));
