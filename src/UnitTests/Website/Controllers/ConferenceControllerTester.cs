...
namespace CodeCampServer.UnitTests.Website.Controllers
{
    ...
    public class ConferenceControllerTester
    {
        ...
        public void ScheduleShouldGetConferenceByKeyAndSendScheduleToTheView()
        {
            ...
            Conference conference = new Conference("austincodecamp2008", "Austin Code Camp");
            SetupResult.For(repository.GetConferenceByKey("austincodecamp2008")).Return(conference);
            mocks.ReplayAll();

            TestingConferenceController controller = new TestingConferenceController(repository);
            ...
            Assert.That(actualViewData.ConferenceName, Is.EqualTo("Austin Code Camp"));
        ...
        private class TestingConferenceController : ConferenceController
        {
            ...
            public TestingConferenceController(IConferenceRepository conferenceRepository) : base(conferenceRepository)
            {
            }
